...
# debian 6
debootstrap --variant=buildd --arch=i386 squeeze /home/chroots/debian_squeeze_i386 http://http.debian.net/debian/
debootstrap --variant=buildd --arch=amd64 squeeze /home/chroots/debian_squeeze_amd64 http://http.debian.net/debian/
# debian 7
