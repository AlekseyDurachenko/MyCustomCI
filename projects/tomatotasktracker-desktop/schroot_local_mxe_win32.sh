...
/home/mxe/usr/i686-w64-mingw32.static/qt/bin/lrelease "${BUILD_DIR}/sources/tomatotasktracker-desktop.pro"
...
zip -r "../tomatotasktracker-desktop_\${APP_VERSION}_win32.zip" *

# copy the .deb packages to the packages directory
cp "${BUILD_DIR}/sources/tomatotasktracker-desktop_\${APP_VERSION}_win32.zip" ${PACKAGE_DIR}/
